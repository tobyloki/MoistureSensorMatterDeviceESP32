...
namespace humidity_measurement {
namespace attribute {
attribute_t *create_humidity_measured_value(cluster_t *cluster, nullable<uint16_t> value);
attribute_t *create_humidity_min_measured_value(cluster_t *cluster, nullable<uint16_t> value);
attribute_t *create_humidity_max_measured_value(cluster_t *cluster, nullable<uint16_t> value);
} /* attribute */
